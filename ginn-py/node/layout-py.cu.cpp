...
void bind_layout_nodes(py::module_& m) {
  ...
  for_each<Real, Half, Int, bool>([&](auto scalar) {
    ...
    m.def("Cat", &Cat<const std::vector<Np>&>);

    PyNode<Scalar, RowwiseCatNode>(m, name<Scalar>("RowwiseCatNode"));
    m.def("RowwiseCat", &RowwiseCat<const std::vector<Np>&>);
    ...
    m.def("Slice",
          &Slice<const Np&, const Shape&, const Shape&>,
          "in"_a,
          "offsets"_a,
          "sizes"_a);
    ...
    m.def("Chip",
          &Chip<const Np&, const Size&, const Size&>,
          "in"_a,
          "offset"_a,
          "dim"_a);
    ...
    m.def("RowBroadcast",
          &RowBroadcast<const Np&, const DimPtr&>,
          "in"_a,
          "size"_a);
    m.def("RowBroadcast",
          &RowBroadcast<const Np&, const Size&>,
          "in"_a,
          "size"_a);

    PyNode<Scalar, ColBroadcastNode>(m, name<Scalar>("ColBroadcastNode"));
    m.def("ColBroadcast",
          &ColBroadcast<const Np&, const DimPtr&>,
          "in"_a,
          "size"_a);
    m.def("ColBroadcast",
          &ColBroadcast<const Np&, const Size&>,
          "in"_a,
          "size"_a);
